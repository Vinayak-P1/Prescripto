...
const doctorList = async(req,res)=>{
   ...
   console.log("Doctors availability status:", doctors.map(d => ({ id: d._id, available: d.available })));
...
const appointmentsDoctor = async (req, res) => {
  try {
    ...
    const appointments = await appointmentModel.find({ docId }).populate('userId', 'name age gender');
